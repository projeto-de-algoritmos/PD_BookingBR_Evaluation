...
func (u User) Create(db orm.DB, usr PD_BookingBR_Evaluation.User) (PD_BookingBR_Evaluation.User, error) {
	var user = new(PD_BookingBR_Evaluation.User)
	...
	if err == nil || err != pg.ErrNoRows {
		return PD_BookingBR_Evaluation.User{}, ErrAlreadyExists
	}
...
func (u User) List(db orm.DB, qp *PD_BookingBR_Evaluation.ListQuery, p PD_BookingBR_Evaluation.Pagination) ([]PD_BookingBR_Evaluation.User, error) {
	var users []PD_BookingBR_Evaluation.User
...
func (u User) Delete(db orm.DB, user PD_BookingBR_Evaluation.User) error {
